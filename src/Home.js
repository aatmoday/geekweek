      ...
      <section id="about" className="center-container">
        ...
        <div className="content">
          <p>
            ...
            all an array of amazing tech events, with a lot of prizes to bag and
            a lot of fun to have! <br /> We invite you to be a part of this
            amazing fun-filled week for tech freaks! <br /> At Geek Week, there
            is something for everyone! Even if you are a techie or not, there
            are many events like{" "}
            <span
              style={{
                fontStyle: "italic",
                fontWeight: "700",
